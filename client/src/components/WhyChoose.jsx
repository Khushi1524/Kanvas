...
const WhyChoose = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row items-center justify-center gap-20 max-w-300 m-auto py-20">
        <div className="max-w-130  bg-red-500 rounded-2xl overflow-hidden">
          <img className="w-full object-cover" src={assets.CTA} alt="" />
        </div>
